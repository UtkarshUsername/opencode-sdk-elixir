defmodule OpenCode.Generated.SessionNextToolSuccessData do
  @moduledoc """
  Provides struct and type for a SessionNextToolSuccessData
  """
  ...
  @type t :: %__MODULE__{
          ...
          provider: OpenCode.Generated.SessionNextToolSuccessDataProvider.t(),
          result: map | nil,
          session_id: String.t(),
          structured: map,
          timestamp: number
