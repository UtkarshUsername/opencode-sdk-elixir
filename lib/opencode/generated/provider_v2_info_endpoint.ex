defmodule OpenCode.Generated.ProviderV2InfoEndpoint do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          package: String.t(),
          reasoning: OpenCode.Generated.ProviderV2InfoEndpointReasoning.t() | nil,
          type: String.t(),
          url: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      package: :string,
      reasoning: {OpenCode.Generated.ProviderV2InfoEndpointReasoning, :t},
      type:
        {:enum,
